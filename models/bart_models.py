...
class BARTModel(nn.Module):
    def __init__(self, vocab: Vocab, pretrained_language_model_name: str, pretrained_language_model_dim=768,
        ...
        language_model = BartModel.from_pretrained(pretrained_language_model_name)
        self.language_model_encoder = language_model.encoder
        self.language_model_layer_norm = nn.LayerNorm(pretrained_language_model_dim)
    ...
    def forward(self, tokens):
        ...
        outs = self.language_model_layer_norm(outs)
        # project to d_model
